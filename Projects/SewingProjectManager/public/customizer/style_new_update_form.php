    ...
    <div class="col-4">
        <h4 class="">Add or Update an Item</h4>
            ...
            <form action="action" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col"> 
                        <label class="form-label float-start">Style</label><input class="form-control" type="text">
                    </div>
                </div>
            </form>
            </div>
                ...
                <div class="">
                <a href="style.php">
                    <button class="btn btn-light btn-outline-primary" type="button">Close</button>
                </a>
