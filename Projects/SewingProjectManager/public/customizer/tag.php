...
<!--end sidebar line 122-->
            <div class="col">
                <h1 style="font-size: 30px;">Tags</h1>
                <p><strong>This is a master list of tags. It can be used to also track who an item is for. Just about any keyword you might want to search on.</strong></p>
                <div class="row">
                    <div class="col" style="text-align: right;">
                    <a href="tag_new_update_form.php">  
