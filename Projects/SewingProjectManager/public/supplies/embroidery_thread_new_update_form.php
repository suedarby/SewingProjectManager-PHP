                    ...
                    <div class="row">
                        <div class="col">
                            <form action="add_modal_action" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">
                                        <label class="form-label text-start float-start" style="text-align: left;">Brand</label>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="form-label float-start">Color</label><input class="form-control form-control-color" type="color">
                                    </div>
                                    <div class="col">
                            ...
                            <div class="">
                                <a href="embroidery_thread.php"><button class="btn btn-light btn-outline-primary" type="button" data-bs-dismiss="">Close</button></a>
