...
<div class="col">
                <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="add__action" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col">
                                        <label class="form-label text-start float-start" style="text-align: left;">Trim</label>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <label class="form-label text-start float-start" style="text-align: left;">Color</label>
                                    <input class="form-control form-control-color" type="color">
                                </div>
                                </div>
                                <div class="row">
                                    <div class="col"><label class="form-label float-start">Yards</label><input class="form-control" type="number"></div>
                                    <div class="col"><label class="form-label float-start">Type</label><input class="form-control" type="text"></div>
                                </div>
                                <div class="row">
                                    <div class="col">
                ...
                <div class="">
                <a href="trim.php"><button class="btn btn-light btn-outline-primary" type="button" data-bs-dismiss="">Close</button></a>
