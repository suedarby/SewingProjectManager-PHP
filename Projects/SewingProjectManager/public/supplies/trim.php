...
<!--end sidebar -->
<div class="col">
<h1 style="font-size: 30px;">Trims</h1>
                <p><strong>A list of Trims. The links under Type will show an additional details page for the item.</strong></p>
                <div class="row">
                    <div class="col" style="text-align: right;">
                        <a href="trim_new_update_form.php">  
                    ...
                    <div class="col">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a href="#">trim_id trim_type</a></td>
                                        <td>trim_id trim_descri<br></td>
                                        <td>trim_id trim_yardage<br></td>
                                        <td>trim_id color_id color<br></td>
                                        <td>trim_id location_id location<br></td>
                                        <td>
