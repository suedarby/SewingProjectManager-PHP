...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-2">
                <ul class="list-group">
                    <li class="list-group-item"><span></span><a href="about.php">About</a></li>
                    <li class="list-group-item"><span></span><a href="news.php">News</a></li>
                </ul>
            </div>
            <div class="col">
                <h1>Register</h1>
                <section class="login-clean" style="width: 334.782px;">
                    <form method="post">
                        ...
                        <div class="mb-3">
                            <div class="form-check"><label class="form-check-label"><input class="form-check-input" type="checkbox"><a href="#">Agree to license terms</a></label></div>
                        </div>
